# Tune List
Tune list is cross platform mobile app for recording keyboard-based music snippets and adding them to an in-app playlist. It was built using React Native, JavaScript, TypeScript, Node.js, and and JSX (HTML based JavaScript). It utilizes local file storage for audio recording and saving, and linked lists for ordered playback. 
...
**6. How the app works:**  
   ...
   Access saved recordings in playlist tab  
